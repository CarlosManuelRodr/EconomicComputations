...
\author{H.R Olivares-S\'anchez$^1$, C.M. Rodr\'{\i}guez-Mart\'{\i}nez$^3$, E. Scalas$^2$,H.Tapia-McClung$^3$, A.R. Hern\'andez-Montoya*$^{3,4}$}
...
\end{abstract}
  ...
  \label{intro}
  INSERTAR TEXTO SOBRE LA IMPORTANCIA DEL EXPERIMENTO Y EL ANÁLISIS DE DATOS EMPÍRICOS EN ECONOPHYSICS
...
Histograms  of the overall of uptrends and downtrends durations for all samples are shown in Figure \ref{fig:AllTrends}.
...
\end{center}
\caption{\small Histogram of the overall of trends duration, of our four data samples. Descriptive statistics is displayed. AQUÍ HAY QUE PONER ESTA FIGURA HECHA CON LOS DATOS ANALIZADOS EN ESTE PAPER. A LO MEJOR LA ESTADÍSTICA DESCRIPTIVA IRÍA MEJOR EN UNA TABLA SEPARADA \label{fig:AllTrends}.}
\end{figure}

In order to perform our analysis, two histograms were built for each market measuring $T_d$ on the whole sample without time windows. One for upward trends and the other one for downward trends. 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{img/AllTReturns}
\end{center}
\caption{\small TReturns histogram for all data samples. Descriptive statistics is displayed. AQUÍ HAY QUE PONER ESTA FIGURA HECHA CON LOS DATOS ANALIZADOS EN ESTE PAPER. A LO MEJOR LA ESTADÍSTICA DESCRIPTIVA IRÍA MEJOR EN UNA TABLA SEPARADA \label{fig:AllTrends}.}
\end{figure}
