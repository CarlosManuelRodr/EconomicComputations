...
\begin{figure}[h!tb]
	\centering
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{img/pvalores_NASDAQ.eps}
            \caption[]{}    
            \label{fig:nasdaq}
        \end{subfigure}
        \quad
        \begin{subfigure}[b]{0.45\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{img/pvalores_IPC.eps}
            \caption[]{}     
            \label{fig:ipc}
        \end{subfigure}
        \vskip\baselineskip
...
\begin{figure}[h!tb]
	\centering
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{img/dist_pos_DJIA.eps}
            \caption[]{}    
        \end{subfigure}
        \quad
        \begin{subfigure}[b]{0.45\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{img/dist_neg_DJIA.eps}
            \caption[]{}     
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.45\textwidth}   
        ...
        \begin{subfigure}[b]{0.45\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{img/dist_neg_IPC.eps}
            \caption[]{}     
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.45\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{img/dist_pos_Nikkei.eps}
            \caption[]{}      
        \end{subfigure}
        \quad
        \begin{subfigure}[b]{0.45\textwidth}   
