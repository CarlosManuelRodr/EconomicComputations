...
\author{M. en F. Carlos Manuel Rodríguez Martínez \\ Advisor: Dr. Alejandro Raúl Hernández Montoya}
...
\begin{itemize}
	\item Dr. Alejandro Raúl Hernandez Montoya. Universidad Veracruzana.
...
\begin{frame}{H.F. Coronel-Brizio, et al. (2007) Assessing symmetry of financial returns series. Physica A 383.}
	...
	\item We can test for $c$ in an interval $[C_{min},C_{max}]$, for example
	  \begin{figure}
        \includegraphics[scale=0.33]{img/new/simetria_retornos_simples_DJIA}
        \caption{$T_n$ symmetry test evaluated on the returns of the DJIA index.}
  \end{figure}
	\item We can affirm with 95 \% certainty that the distribution is symmetrical in a interval between 0.0003 and 0.0006.
	\end{itemize}
...
%-----------------------------------------------------------------------------
\begin{frame}
\frametitle{Symmetry tests: Simple returns}
  	  \begin{figure}[h!]
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[scale=0.30]{img4/SymmetryPlots/simetria_retornos_simples_DAX}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[scale=0.30]{img4/SymmetryPlots/simetria_retornos_simples_IPC}
		\end{subfigure}%
	\end{figure}

  \begin{figure}
        \includegraphics[scale=0.35]{img2/SymmetryNotAtMean.eps}
        \caption{Symmetry test for 1 day returns} 
  \end{figure}
\end{frame}
...
\frametitle{Symmetry tests: Trend returns}
		...
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[scale=0.35]{img4/SymmetryPlots/simetria_TReturns_DAX}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[scale=0.35]{img4/SymmetryPlots/simetria_TReturns_IPC}
		\end{subfigure}%
	\end{figure}
	  	  \begin{figure}[h!]
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[scale=0.35]{img4/SymmetryPlots/simetria_TReturns_DJIA}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[scale=0.35]{img4/SymmetryPlots/simetria_TReturns_NIKKEI225}
		\end{subfigure}%
	\end{figure}
\end{frame}
...
\frametitle{Conclusion}
  \begin{itemize}
  	...
  	\item Symmetry is not constant. Particularly symmetry around $c=0$ tends to be not plausible in dates closer to extreme events.
  \end{itemize}
\end{frame}
